...
<!--\[if !supportLists]-->·        <!--\[endif]-->Personale Funktion von Bewegung: für sich selbst und den eigenen Körper

<!--\[if !supportLists]-->·        <!--\[endif]-->Soziale Funktion von Bewegung: mit anderen etwas tun

<!--\[if !supportLists]-->·        <!--\[endif]-->Produktive Funktion von Bewegung: selber etwas schaffen, herstellen

<!--\[if !supportLists]-->·        <!--\[endif]-->Expressive Funktion von Bewegung: Gefühle und Empfindungen ausdrücken, ausleben, verarbeiten

<!--\[if !supportLists]-->·        <!--\[endif]-->Impressive Funktion von Bewegung: Gefühle empfinden, körperlich spüren

<!--\[if !supportLists]-->·        <!--\[endif]-->Explorative Funkton von Bewegung: Umwelt kennen lernen und sich erschließen

<!--\[if !supportLists]-->·        <!--\[endif]-->Komparative Funktion von Bewegung: sich mit anderen vergleichen, Frustrationstoleranz ausbauen

<!--\[if !supportLists]-->·        <!--\[endif]-->Adaptive Funktion von Bewegung: Belastungen ertragen, körperl. Grenzen kennenlernen
